...
Versión 2026 (semestre 1, sección 3) del curso de BD de la PUC
...
Puede solicitar recorrección [ACÁ](por_definir).

## Mejora Continua

Ayúdanos a mejorar las cátedras, ayudantías, issues, correcciones o el proyecto [AQUÍ](por_definir). :star:
...
------------------- | ------- | ---------------------
	Juan Reutter    | 3      | [jreutter@ing.puc.cl]
...
La página de [_Issues_](https://github.com/IIC2413/Syllabus-2026-1-s3/issues) se utilizará como foro para preguntas. Notar que las etiquetas ya se encuentran definidas. **Este es el único canal oficial para formular preguntas**.
